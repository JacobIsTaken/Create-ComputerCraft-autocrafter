...
-- LV Capacitor
local lv_capacitor = {"immersiveengineering:capacitor_lv", "chisel:antiblock/gray", "createaddition:capacitor", "immersiveengineering:treated_wood_horizontal", "emendatusenigmatica:copper_rod", "minecraft:redstone_block", "emendatusenigmatica:copper_rod", "tconstruct:large_plate"}

-- MV Capacitor
local mv_capacitor = {"immersiveengineering:capacitor_mv", "chisel:antiblock/brown", "immersiveengineering:capacitor_lv", "immersiveengineering:treated_wood_horizontal", "emendatusenigmatica:electrum_rod", "minecraft:redstone_block", "emendatusenigmatica:electrum_rod", "tconstruct:large_plate"}

-- HV Capacitor
local hv_capacitor = {"immersiveengineering:capacitor_hv", "chisel:antiblock/black", "immersiveengineering:capacitor_mv", "immersiveengineering:treated_wood_horizontal", "emendatusenigmatica:aluminum_rod", "minecraft:redstone_block", "emendatusenigmatica:aluminum_rod", "tconstruct:large_plate"}

-- Redstone Engineering Block
local red_engineering_block = {"immersiveengineering:rs_engineering", "chisel:antiblock/red", "immersiveengineering:sheetmetal_iron", "immersiveengineering:component_iron", "twilightforest:carminite", "immersiveengineering:wirecoil_redstone", "twilightforest:carminite", "immersiveengineering:component_iron", "immersiveengineering:component_iron", "twilightforest:carminite", "immersiveengineering:wirecoil_redstone", "twilightforest:carminite", "immersiveengineering:component_iron"}

-- Heavy Engineering Block
local heavy_engineering_block = {"immersiveengineering:heavy_engineering", "chisel:antiblock/purple", "immersiveengineering:sheetmetal_aluminum", "immersiveengineering:component_steel", "emendatusenigmatica:electrum_dust", "create:precision_mechanism", "emendatusenigmatica:electrum_dust", "immersiveengineering:component_steel", "immersiveengineering:component_steel", "emendatusenigmatica:electrum_dust", "create:precision_mechanism", "emendatusenigmatica:electrum_dust", "immersiveengineering:component_steel"}

-- Light Engineering Block
local light_engineering_block = {"immersiveengineering:light_engineering", "chisel:antiblock/blue", "immersiveengineering:sheetmetal_steel", "immersiveengineering:component_iron", "atum:nebu_ingot", "create:precision_mechanism", "atum:nebu_ingot", "immersiveengineering:component_iron", "immersiveengineering:component_iron", "atum:nebu_ingot", "create:precision_mechanism", "atum:nebu_ingot", "immersiveengineering:component_iron"}
